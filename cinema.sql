...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2022 at 01:36 PM
...
(32, 'prof', 'd9f02d46be016f1b301f7c02a4b9c4ebe0dde7ef', 'prof@gmail.com', 612345678);
...
(1003, 'doctor strange', 'Scott Derrickson', 'Benedict Cumberbatch · Doctor Stephen Strange ; Elizabeth Olsen · Wanda Maximoff ; Chiwetel Ejiofor · Baron Mordo ; Benedict Wong · Wong ..', '2022-01-01');
...
(1, 1001, '2022-06-17 09:40:50', '4 '),
(2, 1002, '2022-06-17 09:40:57', '2 '),
(3, 0, '2022-06-17 09:41:04', '5');
...
('admin', 'The Wolf of Wall Street', '2022-05-18 19:59:16', '4 $'),
('anouar', 'The Wolf of Wall Street', '2022-05-18 19:59:16', '4 $');
...
--
ALTER TABLE `films`
  MODIFY `id_film` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1004;
COMMIT;
